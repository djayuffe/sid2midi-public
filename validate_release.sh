...
required = [
    ...
    'REQUIREMENTS.md', 'LICENSE.md', 'PROJECT_MANIFEST.md', 'RELEASE_NOTES_v3.1.3.md', 'RELEASE_NOTES_v3.1.2.md', 'RELEASE_NOTES_v3.1.1.md', 'RELEASE_NOTES_v3.1.0.md', 'RELEASE_NOTES_v3.0.0.md',
