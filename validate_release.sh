...
required = [
    ...
    'REQUIREMENTS.md', 'LICENSE.md', 'PROJECT_MANIFEST.md', 'RELEASE_NOTES_v3.1.1.md', 'RELEASE_NOTES_v3.1.0.md', 'RELEASE_NOTES_v3.0.0.md',
    ...
    'tests/test_fast_vic_open_bus.py', 'tests/test_sid_writeback_rules.py',
    'tools/testbench.py',
    ...
    'docs/audits/SID2MIDI_3_1_0_AUDIT.md', 'COPYING',
]
